...
def deletar_dados():
    ...
    if escolha == "1":
        ...
        if preco_venda_milho_saca is not None and preco_venda_milho_saca > 0:
            preco_venda_milho_saca = 0
            print("Preço da saca de milho (60 kg) deletada com sucesso!")
            print("Esse dado foi deletado. Vá para a opção 3 no menu principal para atualizar os dados.")
        else:
            print("Nenhum dado para deletar em preço da saca de milho (60 kg).")
    elif escolha == "9":
        if preco_venda_soja_saca is not None and preco_venda_soja_saca > 0:
            preco_venda_soja_saca = 0
            print("Preço da saca de soja (60 kg) deletada com sucesso!")
            print("Esse dado foi deletado. Vá para a opção 3 no menu principal para atualizar os dados.")
        else:
            print("Nenhum dado para deletar em preço da saca de soja (60 kg).")
    elif escolha == "10":
        if preco_insumo_milho_saca is not None and preco_insumo_milho_saca > 0:
            preco_insumo_milho_saca = 0
        ...
        if preco_insumo_soja_saca is not None and preco_insumo_soja_saca > 0:
            preco_insumo_soja_saca = 0
